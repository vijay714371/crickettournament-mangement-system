								...
								<tr>
									<td>
										<div class="card-body d-flex">
											...
											<td class="p-3"><a
												href="DeleteServlet?note_id=<%= team.getId() %>"
												class="btn btn-danger">Delete</a>&nbsp &nbsp</td>
											<td class="p-3"><a
												href="Result.jsp?team_id= <%= team.getId() %>"
												class="btn btn-primary">Result</a>&nbsp &nbsp</td>
